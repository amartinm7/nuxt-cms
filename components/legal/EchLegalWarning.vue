  ...
  <div>
    ...
    >
      ...
      <div class="uk-padding-large">
        ...
        <ul>
          <li>correo electronico: armadadel73@gmail.com</li>
          <li>sitio web: www.estrenoscinehoy.com</li>
        </ul>
      </div>
      <div class="uk-padding-large">
        <h2>Finalidad</h2>
        <p>
          La finalidad del sitio Web estrenoscinehoy.com es informar sobre
          peliculas y series. Nada relacionado con descargas ilegales ni
          pirateria. Solo informar
        </p>
      </div>
      <div class="uk-padding-large">
      ...
      <div class="uk-padding-large">
        ...
        <p>
          ...
          para registrarse en el sitio Web o utilizarlo. Si reside en un país
          que no pertenezca a la Región europea, debe tener al menos 13 años de
          edad para usar el sitio Web o la mayoría de edad que se requiera su
          país para registrarse en el sitio Web o utilizarlo.
        </p>
        <p>
          ...
          aceptar nuestras condiciones en su país, su padre, madre, o tutor
          deben aceptar nuestras condiciones en su nombre.
        </p>
      </div>
      <div class="uk-padding-large">
      ...
      <div class="uk-padding-large">
        ...
        <p>
          El Titular sólo obtiene y conserva la siguiente información acerca de
          los visitantes del Sitio Web:
        </p>
        <ul>
          <li>
            El nombre de dominio del proveedor (PSI) y/o dirección IP que les da
            acceso a la red.
          </li>
          <li>La fecha y hora de acceso al sitio Web.</li>
          <li>
            Política de CookiesLa dirección de Internet origen del enlace que
            dirige al sitio Web.
          </li>
      ...
      <div class="uk-padding-large">
        ...
        <p>
          ...
          destino, que están fuera del control del Titular, por lo que Titular
          no es responsable del contenido de los sitios web vinculados ni del
          resultado que obtenga al seguir los enlaces.
        </p>
        <p>
        ...
        <p>
          ...
          de relaciones entre Titular y el propietario del sitio en el que se
        ...
        <p>
          ...
          Sitio Web usted deberá leer la propia política de privacidad del otro
      ...
      <div class="uk-padding-large">
        ...
        <p>
          La información que aparece en estos enlaces de afiliados o los
          anuncios insertados, son facilitados por los propios anunciantes, por
          lo que Titular no se hace responsable de posibles inexactitudes o
          errores que pudieran contener los anuncios, ni garantiza en modo
          alguno la experiencia, integridad o responsabilidad de los anunciantes
          o la calidad de sus productos y/o servicios.
        </p>
      </div>
      <div class="uk-padding-large">
      ...
      <div class="uk-padding-large">
        ...
        <p>
          ...
          sitio Web pueden incluir incorrecciones o errores tipográficos. De
          forma periódica el Titular incorpora mejoras y/o cambios a la
          información contenida y/o los Servicios que puede introducir en
          cualquier momento.
        </p>
        <p>
        ...
        <p>
          ...
          Titular no se hace responsable por caídas de la red, pérdidas de
          negocio a consecuencia de dichas caídas, suspensiones temporales de
          fluido eléctrico o cualquier otro tipo de daño indirecto que te pueda
          ser causado por causas ajenas a el Titular.
        </p>
        <p>
      ...
      <div class="uk-padding-large">
        ...
        <p>
          ...
          puedan derivarse de su uso, las partes acuerdan someterse a los Jueces
          y Tribunales de la provincia de Madrid, con renuncia expresa de
